...
//            $("#myorder").text();
           imgsrc=$(this).attr("src");
            $("#myorder").append(name+'<img src="'+imgsrc+'"/>' );
        }
    });
...
//alert(orders);
        $.ajax({
            ...
            url: "/cafee/public/Order/confirmuserorder?myorder="+myorder,
            //data: JSON.stringify(orders),
         
            success: function (msg) {
                latest = $($.parseHTML(msg)).find("#latestorder");
                latestcurr = $("#latestorder");
                latestcurr.html(latest);
